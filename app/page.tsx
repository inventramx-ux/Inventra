...
export default function Home() {
  ...
  const plans = [
    ...
    },
    {
      ...
      features: ["Publicaciones ilimitadas", "Métricas de publicaciones ilimitadas", "Soporte prioritario"],
      cta: "Comenzar ahora",
      highlighted: false,
    },
  ];
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Inventra está diseñado para vendedores de e-commerce que necesitan crear publicaciones rápidas, claras y optimizadas para plataformas como Mercado Libre, Facebook Marketplace y más.",
    },
    {
    ...
    },
    {
      ...
      answer: "Sí. No necesitas tener un e-commerce propio. Inventra funciona para cualquier persona que necesite crear publicaciones para vender productos en plataformas online.",
    },
    {
      question: "¿Qué nos diferencia de la competencia?",
      answer: "Inventra está específicamente diseñado para crear publicaciones de e-commerce. Utiliza formatos optimizados, estructuras de venta probadas y datos actualizados de las plataformas para generar publicaciones listas para publicar.",
    },
    {
...
>
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      ...
      >
        <div className="max-w-4xl mx-auto">
          <h1 className="text-[20px] text-gray-400 line-clamp-2">Preguntas Frecuentes</h1>
          <h2 className="text-3xl font-semibold text-white mb-6">
            <span className="block max-w-[600px] text-white/25 lg:text-[50px] font-semibold mb-6 leading-[1.15] tracking-tight
bg-gradient-to-b from-white via-white to-gray-400
bg-clip-text text-transparent pb-2">Preguntas Frecuentes </span>
          </h2>
...
<p className="text-gray-500 text-sm flex items-center gap-2">
                ...
                El mejor AI para publicaciones de e-commerce en México y Latinoamérica.
              </p>
            </div>
            <div className="flex items-center gap-2">
              <a
